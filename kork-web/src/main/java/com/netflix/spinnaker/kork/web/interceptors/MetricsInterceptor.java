...
public class MetricsInterceptor implements HandlerInterceptor {
  ...
  private final Set<String> pathVariablesToTag = new HashSet<>();
  private final Set<String> queryParamsToTag = new HashSet<>();
  private final Set<String> controllersToExclude = new HashSet<>();
